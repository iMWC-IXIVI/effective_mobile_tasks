...
class User(ABC):
    ...
    discount: list[Any[LoyaltyDiscount, SpecDiscount], ] (тип скидки для пользователя, могут быть несколько)
    """
    def __init__(self, name: str, date_of_birth: date) -> None:
        ...
        self.discount: list[Any[LoyaltyDiscount, SpecDiscount], ] | None = None
